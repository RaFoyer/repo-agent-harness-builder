...
4. Validate the registry with `./verify-harness orchestration validate`.
...
./verify-harness orchestration instances
./verify-harness orchestration init <instance>
./verify-harness orchestration migrate <instance>
./verify-harness orchestration hierarchy
./verify-harness orchestration trust
...
./verify-harness orchestration directives
...
./verify-harness orchestration prompt boss
./verify-harness orchestration prompt <node-id>
...
baseline with `./verify-harness orchestration adapter-status --example`, preview
portable presentation labels with
`./verify-harness orchestration taxonomy --example`, and read
...
- `./verify-harness orchestration validate` reports no blockers.
