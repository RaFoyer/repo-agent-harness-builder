...
./verify-harness connections doctor --profile <profile-id> --mode remote
...
5. Run `./verify-harness connections status`.
6. If login or local CLI auth is needed, run `./verify-harness connections auth-plan --profile <profile-id>`.
