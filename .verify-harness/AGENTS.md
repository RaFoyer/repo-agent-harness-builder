# Verification Harness Agent Instructions
...
- Use `./verify-harness` for repeatable repository operations instead of ad hoc command sequences.
...
1. Run `./verify-harness preflight` if the CLI is available.
