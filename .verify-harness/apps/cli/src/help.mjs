...
Usage:
  ./verify-harness <command> [options]
...
Safety posture:
  ...
  - Codex task pins are navigation only: pin the resident Boss and nonterminal Managers, never Workers or helpers, and unpin Managers only after terminal completion and landed-work evidence plus parent reconciliation
